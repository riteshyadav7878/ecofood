...
<input type="text" placeholder="Search..." />
    ...
    document.addEventListener('DOMContentLoaded', function() {
        const form = document.querySelector('form.theme-form');
        ...
        form.addEventListener('submit', function(event) {
            ...
            if (usernameInput.value.trim() === '') {
                showWarning(usernameInput, 'Username is required');
                isValid = false;
            }
            ...
            if (emailInput.value.trim() === '') {
                showWarning(emailInput, 'Email is required');
                isValid = false;
            } else if (!validateEmail(emailInput.value.trim())) {
                showWarning(emailInput, 'Invalid email address');
                isValid = false;
            }
            ...
            if (passwordInput.value.trim() === '') {
                showWarning(passwordInput, 'Password is required');
                isValid = false;
            }

            // Check if privacy checkbox is checked
            const privacyCheckbox = form.querySelector('input#privacy');
            if (!privacyCheckbox.checked) {
                showWarning(privacyCheckbox, 'You must agree to the Privacy Policy');
                isValid = false;
            }
        ...
        function showWarning(input, message) {
            ...
            // Add warning message below input
