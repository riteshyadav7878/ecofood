...
<head>
    ...
    <script>
        function validateForm() {
            ...
            const privacy = document.forms["registrationForm"]["privacy"].checked;

            let valid = true;

            if (username === "") {
                document.getElementById("username-error").textContent = "Username must be filled out.";
                valid = false;
            }
            ...
            <div class="row">
                <div class="col-md-4 col-md-push-4">
                    <div class="register-1">
                        <form class="theme-form" name="registrationForm" action="register.php" method="post" onsubmit="return validateForm()">
                            ...
                            <div class="form-group">
                                <input class="theme-input-text" type="password" name="password" placeholder="Password" />
