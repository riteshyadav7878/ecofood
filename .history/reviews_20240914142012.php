        ...
        <div class="table-container">
            ...
            if ($review_result && mysqli_num_rows($review_result) > 0) {
                ...
                while ($review = mysqli_fetch_assoc($review_result)) {
                    // Debugging: Display the actual image path for now
                    echo '<tr>';
                    echo '<td>' . htmlspecialchars($review['product_title']) . '</td>';
                    echo '<td>' . htmlspecialchars($review['product_image']) . '</td>'; // Display image path for debugging
                    echo '<td><img src="' . htmlspecialchars($review['product_image']) . '" alt="Product Image" class="product-image"></td>';
