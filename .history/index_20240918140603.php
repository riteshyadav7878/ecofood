        ...
        <div class="container">
            ...
            <div class="last-blog-list m-t-50">
                <div class="row">
                    ...
                    $query = "SELECT * FROM blog_posts ORDER BY created_at DESC LIMIT 3"; // Adjust table and column names as needed
                    $result = mysqli_query($conn, $query);
                        ...
                        <div class="col-md-4">
                            <div class="blog-item-1">
                                <div class="blog-item-image">
                                    <a href="blog.php?id=<?php echo urlencode($row['id']); ?>">
                                ...
                                <p class="blog-item-date">
                                    ...
                                    <span>on <?php echo date('F j, Y', strtotime($row['created_at'])); ?></span>
                                </p>
                            </div>
                        </div>
                        <?php
