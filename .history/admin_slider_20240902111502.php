...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if (isset($_FILES['image_file']) && $_FILES['image_file']['error'] == 0) {
            ...
            if ($uploadOk == 0) {
                ...
                if (move_uploaded_file($_FILES["image_file"]["tmp_name"], $target_file)) {
                    ...
                    $sql = "INSERT INTO sliders (image_url, title, description, status) VALUES ('$image_url', '$title', '$description', 'inactive')";
        ...
        if (isset($_FILES['image_file']) && $_FILES['image_file']['error'] == 0) {
            ...
            if ($uploadOk == 0) {
                ...
                if (move_uploaded_file($_FILES["image_file"]["tmp_name"], $target_file)) {
                    ...
                    $sql = "UPDATE sliders SET image_url='$image_url', title='$title', description='$description' WHERE id=$slider_id";
            ...
            $sql = "UPDATE sliders SET title='$title', description='$description' WHERE id=$slider_id";
    ...
    if (isset($_POST['toggle_status'])) {
        ...
        $sql = "UPDATE sliders SET status='$new_status' WHERE id=$slider_id";
