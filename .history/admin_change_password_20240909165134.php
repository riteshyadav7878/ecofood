...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['change_password'])) {
    ...
    if (isset($_SESSION['admin_id'])) {
        ...
        // Debug: Check if admin_id is set correctly
        echo 'Admin ID from session: ' . $admin_id . '<br>'; // Remove this line after debugging
        ...
        if ($result->num_rows > 0) {
            ...
            // Debug: Output SQL error or check if the admin exists
            echo "SQL Query: " . $sql . '<br>'; // Remove this after debugging
            $message = '<div class="alert alert-danger" role="alert">Admin not found. Please ensure your session is valid.</div>';
        }
    } else {
