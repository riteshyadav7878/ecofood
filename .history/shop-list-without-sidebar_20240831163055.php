...
<div class="row">
  ...
  <div class="col-md-3 col-sm-6">
    <div class="product-1">
      ...
      <div class="product-content">
        <h3 class="title">
          <a class="name" href="product-details-4.php">Fresh cherry</a>
        </h3>
  ...
  <div class="col-md-3 col-sm-6">
    <div class="product-1">
      <div class="product-image">
        <a href="product-details-15.php">
          <div class="image-holder">
            <img src="images/product-item-15.jpg" alt="Asparagus" />
          </div>
        </a>
      </div>
      <div class="product-content">
        <h3 class="title">
          <a class="name" href="product-details-15.php">Asparagus</a>
        </h3>
  ...
  <div class="col-md-3 col-sm-6">
    <div class="product-1">
      <div class="product-image">
        <a href="product-details-16.php">
          <div class="image-holder">
            <img src="images/product-item-16.jpg" alt="Acai berry 250ml" />
          </div>
        </a>
      </div>
      <div class="product-content">
        <h3 class="title">
          <a class="name" href="product-details-16.php">Acai berry 250ml</a>
        </h3>
        <p class="price">$10.00</p>
      </div>
    </div>
