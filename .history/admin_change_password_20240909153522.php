...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['change_password'])) {
        ...
        $sql = "SELECT * FROM admin WHERE id='$admin_id'"; // Ensure 'id' is the correct column name
        ...
        if ($result->num_rows > 0) {
            ...
            if (password_verify($current_password, $admin['password'])) {
                ...
                if ($new_password === $confirm_password) {
                    ...
                    $update_sql = "UPDATE admin SET password='$hashed_new_password' WHERE id='$admin_id'"; // Ensure 'id' is the correct column name
...
<body>
    <?php include 'admin_Navbar.php'; // Include navbar ?>

    <div class="container">
        <div class="change-password-container">
            <h1 class="text-center mb-4">Change Password</h1>
            <?php if (isset($message)) echo $message; // Display message if set ?>
