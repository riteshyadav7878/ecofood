...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['change_password'])) {
        ...
        $sql = "SELECT * FROM admin WHERE admin_id='$admin_id'"; // Ensure 'admin_id' is the correct column name
        ...
        if ($result->num_rows > 0) {
            ...
            if (password_verify($current_password, $admin['password'])) {
                ...
                if ($new_password === $confirm_password) {
                    ...
                    $update_sql = "UPDATE admin SET password='$hashed_new_password' WHERE admin_id='$admin_id'"; // Ensure 'admin_id' is the correct column name
