                ...
                <?php while ($row = mysqli_fetch_assoc($result)): ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <button class="btn btn-warning btn-sm" onclick="showUpdateForm(<?php echo htmlspecialchars($row['id']); ?>, '<?php echo addslashes(htmlspecialchars($row['title'])); ?>', '<?php echo addslashes(htmlspecialchars($row['description'])); ?>', '<?php echo addslashes(htmlspecialchars($row['image'])); ?>')">Update</button>
                        </td>
                    </tr>
                <?php endwhile; ?>
            </tbody>
