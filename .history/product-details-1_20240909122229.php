                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="blog-item-1">
                            <div class="blog-item-image">
                                <a href="#">
                                    <img src="images/blog-item-01.jpg" alt="Change: Keep your veggie fresh and tasty" />
                                </a>
                            </div>
                            <div class="blog-item-title">
                                <h3 class="title">
                                    <a href="#">Change: Keep your veggie fresh and tasty</a>
                                </h3>
                            </div>
                            <p class="blog-item-date">
                                <i class="fa fa-clock-o"></i>
                                <span>on April 29, 2017</span>
                            </p>
                    ...
                    <div class="col-md-6">
                        <div class="blog-item-1">
                            <div class="blog-item-image">
                                <a href="#">
                                    <img src="images/blog-item-02.jpg" alt="Make: A healthy and delicious St. Patrick’s day smoothie" />
                                </a>
                            </div>
                            <div class="blog-item-title">
                                <h3 class="title">
...
<script>
    ...
    document.querySelectorAll('.blog-item-1').forEach(function(item) {
        var link = item.querySelector('.blog-item-image a');
        var img = link.querySelector('img');
        var title = item.querySelector('.blog-item-title h3').textContent;
        var description = item.querySelector('.blog-item-content').textContent;

        link.addEventListener('click', function(e) {
            e.preventDefault(); // Prevent the default link behavior
            openPopup(img.src, title, description);
        });
    });
</script>
</body>
