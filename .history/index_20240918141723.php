    ...
    <div class="section white-background">
        <div class="container">
            ...
            <div class="product-list m-t-50">
                ...
                // Fetch product data with descending order
                    $query = "SELECT id, image, title, price, status FROM product ORDER BY id DESC LIMIT 8";
                            ...
                            <div class="col-md-3 col-sm-6 mt-5">
                                <div class="product-1">
                                    ...
                                    <div class="product-content">
                                        <h3 class="title">
                                            <a class="name" href="product-details-02.php?id=<?php echo $row['id']; ?>"><?php echo htmlspecialchars($row['title']); ?></a>
                                        </h3>
...
$query_blog = "SELECT image, title, description, created_at FROM blog_posts WHERE id = $blog_id";
...
$query_other = "SELECT id, image, title FROM blog_posts WHERE id != $blog_id ORDER BY created_at DESC LIMIT 5";
$result_other = mysqli_query($conn, $query_other);

// Check query execution for other blog posts
if (!$result_other) {
    die("Failed to fetch other blog posts: " . mysqli_error($conn));
}
?>
