...
$cart_empty = true; // Default to empty cart
$total = 0;

// Fetch cart data from the database
$sql = "SELECT * FROM cart"; // Adjust if your table is named differently
...
// Fetch submitted records from the orders table
$sql_orders = "SELECT o.*, u.username, u.email AS user_email FROM orders o LEFT JOIN users u ON o.user_id = u.id ORDER BY o.order_date DESC";
...
<div class="container">
    <?php if ($cart_empty): ?>
        <div class="text-center mt-5">
            <h3 class="text-danger">No items in the cart</h3>
        </div>
    <?php else: ?>
...
<script src="vendor/animate.css/animate.min.js"></script>
