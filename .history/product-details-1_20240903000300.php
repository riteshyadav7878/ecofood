...
if (isset($_GET['id'])) {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        if ($reviewer_name && $review_text) {
            $insert_sql = "INSERT INTO reviews (product_id, reviewer_name, review_text) VALUES ($product_id, '$reviewer_name', '$review_text')";
        ...
        <div class="reviews">
            <?php if ($reviews): ?>
                <?php foreach ($reviews as $review): ?>
                    <div class="review">
                        <p><strong><?php echo htmlspecialchars($review['reviewer_name']); ?>:</strong> <?php echo htmlspecialchars($review['review_text']); ?></p>
                        <small><em><?php echo date('F j, Y, g:i a', strtotime($review['created_at'])); ?></em></small>
                        <hr>
                    </div>
                <?php endforeach; ?>
            <?php else: ?>
