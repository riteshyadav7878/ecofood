...
To show red-colored alerts using JavaScript when required fields in the form are left blank, you can follow these steps:

Add Alert Containers: Place span elements next to each input field to display error messages.

Add JavaScript Validation: Create a JavaScript function to validate the form on submission and display appropriate error messages if any fields are blank.

Here’s how you can modify your code to include these features:

Updated HTML Form
Add span elements for error messages in your form:
...
<div class="container mt-5">
    ...
    <form id="product-form" action="" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <span id="image-error" class="form-error"></span>
        </div>
