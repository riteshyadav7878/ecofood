...
<head>
    ...
    <style>
        ...
        .table td {
            ...
            width: 16%;
            /* Adjust width as needed to fit all columns */
        }
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form id="editForm<?php echo $row['id']; ?>" action="" method="POST" enctype="multipart/form-data">
                                            <input type="hidden" name="id" value="<?php echo $row['id']; ?>">
                                            <div class="form-group">
    ...
    <script>
        ...
        function validateForm(formId) {
            ...
            inputs.forEach(function(input) {
                ...
                if (input.value.trim() === '' || (input.type === 'text' && isNaN(input.value.trim()) && input.id === 'edit_price')) {
