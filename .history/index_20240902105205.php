...
<div class="col-md-3 col-sm-6">
    <div class="product-1">
        ...
        <div class="product-content">
            <h3 class="title">
                <a class="name" href="product-details-02.php">Organic broccoli</a>
            </h3>
...
<div class="col-md-3 col-sm-6">
    <div class="product-1">
        ...
        <div class="product-content">
            <h3 class="title">
                <a class="name" href="product-details-3.php">Strawberries</a>
            </h3>
...
<div class="col-md-3 col-sm-6">
    <div class="product-1">
        ...
        <div class="product-content">
            <h3 class="title">
                <a class="name" href="product-details-4.php">Lemon 250ml glass</a>
            </h3>
...
<div class="col-md-3 col-sm-6">
    <div class="product-1">
        ...
        <div class="product-content">
            <h3 class="title">
                <a class="name" href="product-details-5.php">Fresh cherry</a>
            </h3>
...
<div class="col-md-3 col-sm-6">
    <div class="product-1">
        ...
        <div class="product-content">
            <h3 class="title">
                <a class="name" href="product-details-6.php">Juice carrot &amp; apple</a>
            </h3>
            <p class="price">$10.00</p>
        </div>
    </div>
...
<div class="col-md-3 col-sm-6">
    <div class="product-1">
        ...
        <div class="product-content">
            <h3 class="title">
                <a class="name" href="product-details-7.php">Organic banana</a>
            </h3>
...
<div class="col-md-3 col-sm-6">
    <div class="product-1">
        ...
        <div class="product-content">
            <h3 class="title">
                <a class="name" href="product-details-8.php">Fresh celery root</a>
            </h3>
