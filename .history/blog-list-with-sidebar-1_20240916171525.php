...
<body>
    ...
    <script>
        ...
        window.addEventListener('click', function (e) { var popup = document.getElementById('popup'); if (e.target == popup) { closePopup(); } });
            // Add event listeners to all popup links
    document.querySelectorAll('.popup-link').forEach(function (link) {
        link.addEventListener('click', function (e) {
            e.preventDefault();
            var imgSrc = this.querySelector('img').src;
            var title = this.querySelector('img').alt;
            var description = this.nextElementSibling.querySelector('.blog-item-content').textContent;
            openPopup(imgSrc, title, description);
        });
    });
</script>
