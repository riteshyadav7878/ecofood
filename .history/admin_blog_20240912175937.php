...
<div class="container">
    ...
    <form method="post" enctype="multipart/form-data" class="mb-4">
        ...
        <div class="form-group">
            ...
            <input type="file" id="image" name="image" class="form-contr>
        </div>
    ...
    <div class="modal-content">
        <form method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" id="update_title" name="title" class="form-control" require>
            </div>
            <div class="form-group">
                <label for="update_description">Description</label>
                <textarea id="update_description" name="description" class="form-control" rows="4" require></textarea>
            </div>
            <div class="form-group">
                <label for="update_image">Image</label>
                <input type="file" id="update_image" name="image" class="form-control" require>
