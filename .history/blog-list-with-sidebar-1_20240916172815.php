...
<head>
    ...
    <style>
        ...
        .blog-item-1 {
            margin-bottom: 30px;
            /* Add some margin between blog items */
        }
...
<body>
    ...
    <script>
        ...
        document.query
        SelectorAll('.popup-link').forEach(function (link) { link.addEventListener('click', function (e) { e.preventDefault(); var imgSrc = this.querySelector('img').src; var title = this.querySelector('img').alt; var description = this.closest('.blog-item-1').querySelector('.blog-item-content').textContent; openPopup(imgSrc, title, description); }); }); </script>
