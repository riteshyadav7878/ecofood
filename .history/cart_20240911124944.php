...
<head>
    ...
    <style>
        ...
        .quantity-input {
            ...
            border: 0.5px solid #ced4da; /* Thinner border */
        ...
        .quantity-container .btn {
            padding: 0.2rem 0.5rem; /* Padding for buttons */
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="quantity-container">
                                        <button type="button" class="btn btn-secondary btn-sm" onclick="decrementQuantity('<?php echo $id; ?>')">-</button>
                                        ...
                                        <button type="button" class="btn btn-secondary btn-sm" onclick="incrementQuantity('<?php echo $id; ?>')">+</button>
                                    </div>
                                </td>
...
<!-- Inline JavaScript for quantity buttons -->
<script>
