...
<div class="row">
<div class="col-md-6">
<h4 class="checkout-heading">02 / Billing & Shipping details</h4>
<div class="input-row m-b-15">
<div class="input-col-5 p-r-5">
<input class="theme-input-text" type="text" placeholder="First name" />
</div>
<div class="input-col-5 p-l-5">
<input class="theme-input-text" type="text" placeholder="Last name" />
</div>
</div>
<div class="input-row m-b-15">
<div class="input-col-10">
<input class="theme-input-text" type="text" placeholder="Company (optinal)" />
</div>
</div>
<div class="input-row m-b-15">
<div class="input-col-5 p-r-5">
<input class="theme-input-text" type="text" placeholder="Address" />
</div>
<div class="input-col-5 p-l-5">
<input class="theme-input-text" type="text" placeholder="Apt, suite, etc. (optinal)" />
</div>
</div>
<div class="input-row m-b-15">
<div class="input-col-5 p-r-5">
<select class="theme-input-text">
...
<div class="input-row m-b-15">
<div class="input-col-10">
<input class="theme-input-text" type="text" placeholder="Postcode / ZIP" />
</div>
</div>
<div class="input-row m-b-15">
<div class="input-col-5 p-r-5">
<input class="theme-input-text" type="text" placeholder="Phone" />
</div>
<div class="input-col-5 p-l-5">
<input class="theme-input-text" type="text" placeholder="Email" />
</div>
</div>
<div class="theme-input-chk-2 m-b-15">
...
<div class="input-row p-t-15">
<div class="input-col-10">
<textarea class="theme-input-text" placeholder="Order notes" rows="10"></textarea>
</div>
</div>
</div>
</div>
...
<h4 class="checkout-heading">03 / Payment information</h4>
<div class="introduce">
<p>Credit card (PayPal)
<a href="#">
<img src="images/icons/ic-payment-method-01.png" alt="payment" />
</a>
<a href="#">
<img src="images/icons/ic-payment-method-02.png" alt="payment" />
</a>
<a href="#">
<img src="images/icons/ic-payment-method-03.png" alt="payment" />
</a>
<a href="#">
<img src="images/icons/ic-payment-method-04.png" alt="payment" />
</a>
<a href="#">
<img src="images/icons/ic-payment-method-05.png" alt="payment" />
</a>
</p>
...
<input class="theme-input-text" type="text" placeholder="Card Number" />
</div>
<div class="input-col-3 p-l-5 p-r-5">
<input class="theme-input-text" type="text" placeholder="Expiry (MM/YY) " />
</div>
<div class="input-col-3 p-l-5">
<input class="theme-input-text" type="text" placeholder="Card Code" />
</div>
</div>
</div>
<div class="checkout-submit m-t-50">
<button class="au-btn au-btn-primary au-btn-radius btn-order-submit" type="submit">PLACE ORDER</button>
</div>
</div>
