    ...
    if (isset($_POST['update_blog'])) {
        ...
        if ($_FILES['image']['error'] == 0) {
            ...
            if (move_uploaded_file($image_tmp_name, $image_path)) {
                $sql = "UPDATE blogs SET title='$title', description='$description', image='$image_name' WHERE id='$blog_id'";
            } else {
                $error = "Image upload failed.";
            }
        } else {
            $sql = "UPDATE blogs SET title='$title', description='$description' WHERE id='$blog_id'";
        }
        ...
        if ($_FILES['image']['error'] == 0) {
            ...
            if (move_uploaded_file($image_tmp_name, $image_path)) {
                $sql = "INSERT INTO blogs (title, description, image) VALUES ('$title', '$description', '$image_name')";
            } else {
                $error = "Image upload failed.";
            }
        } else {
...
$sql = "SELECT b.id, b.title, b.description, b.image, b.created_at FROM blogs b ORDER BY b.created_at DESC";
$result = mysqli_query($conn, $sql);
?>
