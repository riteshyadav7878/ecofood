...
<head>
    ...
    <style>
        ...
        .btn-custom-edit {
            ...
            background-color: #6c757d; /* Custom color for the Edit button */
            border-color: #6c757d;
        }
        .btn-custom-delete {
            background-color: #dc3545; /* Custom color for the Delete button */
            border-color: #dc3545;
        }
    </style>
</head>
        ...
        <table class="table table-bordered mt-3">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><img src="<?php echo $row['image_url']; ?>" alt="Slider Image" style="width:100px;height:auto;"></td>
                    ...
                    <td>
                        <form action="" method="post" style="display:inline;">
                            ...
                            <button type="submit" class="btn btn-warning" name="toggle_status">
                    ...
                    <td>
                        <form action="" method="post" style="display:inline;">
                            <input type="hidden" name="slider_id" value="<?php echo $row['id']; ?>">
                            <button type="submit" class="btn btn-custom-delete" name="delete_slider">Delete</button>
                        </form>
                        <button type="button" class="btn btn-custom-edit" data-toggle="modal" data-target="#editModal<?php echo $row['id']; ?>">Edit</button>
