    ...
    <script>
        ...
        function validateAddForm() {
            ...
            if (description.value.trim() === "") {
                description.style.border = "2px solid red"; showError("descriptionError", "Description is required", description); isValid = false; }
if (image.value === "") {
    ...
    // Show Update Blog Post Form in Modal
    function showUpdateForm(id, title, description, image) {
        ...
        if (image) {
            ...
            document.getElementById("update_image_preview").style.display = "none";
        }

        document.getElementById("updateModal").style.display = "flex";
    }

    // Close Update Blog Post Form
