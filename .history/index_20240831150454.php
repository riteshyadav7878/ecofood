...
.carousel-item {
    height: 500px; /* Set a fixed height for carousel items */
}

.carousel-item img {
    object-fit: cover; /* Ensures the image covers the container without stretching */
    width: 100%;
    height: 100%; /* Ensures the image fills the height set for the carousel item */
    max-height: 500px; /* Optional: If you want to restrict the maximum height */
}
        ...
        <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
                ...
                <div class="carousel-item <?php echo $active; ?>">
                    <img src="<?php echo htmlspecialchars($row['image_url']); ?>" class="d-block w-100 carousel-image" alt="Slider Image">
