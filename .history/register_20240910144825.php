...
<head>
    ...
    <style>
        /* CSS for invalid and valid input fields */
        input.invalid {
                ...
                <div class="col-md-4 col-md-push-4">
                    <div class="register-1">
                        <form class="theme-form" action="register.php" method="post" onsubmit="return validateForm()">
                            <input class="theme-input-text" type="text" name="username" id="username" placeholder="Username" />
                            <input class="theme-input-text" type="email" name="email" id="email" placeholder="Email" />
                            <input class="theme-input-text" type="password" name="password" id="password" placeholder="Password" />
