            ...
            <tr>
                ...
                <td>
                    ...
                    <form method="POST" enctype="multipart/form-data" class="edit-form">
                        ...
                        <input type="text" name="title" value="<?php echo htmlspecialchars($row['title']); ?>" class="form-control edit-input" required>
                        <textarea name="description" class="form-control edit-input" required><?php echo htmlspecialchars($row['description']); ?></textarea>
