...
if (!isset($_SESSION['admin_id']) || empty($_SESSION['admin_id'])) {
    echo '<div class="alert alert-danger" role="alert">Session admin_id is not set.</div>';
    exit();
}
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['change_password'])) {
    ...
    // Print the admin_id for debugging
    ...
    if (!$result) {
        echo '<div class="alert alert-danger" role="alert">Query Error: ' . $conn->error . '</div>';
        exit();
    }
