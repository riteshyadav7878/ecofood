...
<!-- Custom styles to make footer smaller and fixed -->
<style>
    /* Make footer smaller */
    .footer-1 {
    ...
    .footer-introduce, .footer-services, .footer-contact {
        margin-bottom: 10px; /* Reduce margin for footer sections */
    }
    ...
    .footer-socials li a {
        color: #fff; /* Make social icons white */
    }
</style>
</head>
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-4">
                    <div class="footer-contact">
                        ...
                        <ul>
                            <li><i class="fa fa-map-marker"></i> <span>256 address name, New York city</span></li>
                            <li><i class="fa fa-clock-o"></i> <span>7:30 Am - 11:00 Pm. Monday - Sunday</span></li>
                            <li><i class="fa fa-phone"></i> <span>(044) 359 0173</span></li>
                        </ul>
                    </div>
                </div>
            </div>
            <div class="footer-bottom">
                <p>© 2024 Designed by Ritesh Yadav. All rights reserved.</p>
