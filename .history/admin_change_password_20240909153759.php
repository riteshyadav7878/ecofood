...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['change_password'])) {
    ...
    $sql = "SELECT * FROM admin WHERE admin_id='$admin_id'"; // Use the correct column name
    ...
    if ($result->num_rows > 0) {
        ...
        if (password_verify($current_password, $admin['password'])) {
            ...
            if ($new_password === $confirm_password) {
                ...
                $update_sql = "UPDATE admin SET password='$hashed_new_password' WHERE admin_id='$admin_id'"; // Use the correct column name
