        ...
        <?php if ($result->num_rows > 0): ?>
            <?php while ($order = $result->fetch_assoc()): ?>
                <div class="order-details">
                    ...
                    <?php
                    $order_id = intval($order['order_id']); // Ensure order_id is an integer
                    ...
                    <a href="edit_order.php?order_id=<?php echo htmlspecialchars($order['order_id']); ?>" class="btn btn-primary">Edit Order</a>
                    <hr>
                </div>
            <?php endwhile; ?>
        <?php else: ?>
