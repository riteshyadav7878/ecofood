...
<head>
    ...
    <style>
        ...
        .popup img {
            ...
            height: auto;
            max-height: 400px; /* Set a max-height to ensure consistent size */
                ...
                <?php while ($row = mysqli_fetch_assoc($result)): ?>
                    <div class="blog-item-1">
                        <div class="blog-item-image">
                            <a href="#" data-image="images/<?php echo htmlspecialchars($row['image']); ?>"
...
<div id="popup" class="popup">
    <div class="popup-content">
        ...
        <p id="popup-description" class="popup-caption"></p>
    </div>
</div>
