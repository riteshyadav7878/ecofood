        ...
        <?php while ($row = mysqli_fetch_assoc($result)) { ?>
            <div class="col-md-3 mb-4">
                <div class="product-image" data-toggle="modal" data-target="#productModal"
                    ...
                    data-image="images/<?php echo htmlspecialchars($row['image'], ENT_QUOTES, 'UTF-8'); ?>"
                    data-id="<?php echo htmlspecialchars($row['id'], ENT_QUOTES, 'UTF-8'); ?>">
                    <img src="images/<?php echo htmlspecialchars($row['image'], ENT_QUOTES, 'UTF-8'); ?>" alt="Product Image" class="img-fluid">
                    <?php if (!empty($row['status'])): ?>
                        <div class="product-status <?php echo htmlspecialchars($row['status'], ENT_QUOTES, 'UTF-8'); ?>">
                            <span><?php echo strtoupper(htmlspecialchars($row['status'], ENT_QUOTES, 'UTF-8')); ?></span>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
