        ...
        <div class="row">
            <div class="col-md-8">
                <div class="blog-content">
                    <?php
                    // Fetch the specific blog post based on ID
                    $blog_id = intval($_GET['id']); // Make sure to sanitize and validate input
            ...
            <div class="col-md-4">
                <div class="sidebar">
                    ...
                    <div class="row">
                        ...
                        $query_other = "SELECT * FROM blog_posts WHERE id != $blog_id ORDER BY created_at DESC LIMIT 5"; // Adjust limit as needed
