...
<head>
    ...
    <style>
        ...
        .nav-menu {
            display: flex;
            justify-content: space-between; /* Adjust space between items as needed */
            list-style: none;
            padding: 0;
            margin: 0;
        }
...
<li class="has-drop">
<a class="has-text-color-hover" href="admin_register.php">Admin Register</a></li>
<button class="btn-caret fa fa-angle-right"></button>
