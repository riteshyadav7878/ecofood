...
<head>
    ...
    <style>
        ...
        .carousel-caption {
            ...
            border-radius: 5px; /* Optional: rounded corners for the caption box */
        }
        .carousel-caption h5 {
            font-weight: bold; /* Make title bold */
            font-size: 2rem; /* Increase font size of title */
        }
        .carousel-caption p {
            font-size: 1.25rem; /* Increase font size of description */
        }
    </style>
</head>
<body>
