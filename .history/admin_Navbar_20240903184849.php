...
<meta charset="UTF-8">
<title>Homepage - Ecofood html5 templates</title>
...
<link href="vendor/bootstrap/dist/css/bootstrap.min.css" rel="stylesheet">
    ...
    <style>
        ...
        .mini-shopcart .head-mini-shopcart {
            background: #f8f9fa;
            padding: 10px;
        ...
        .mini-shopcart .item-mini-shopcart img {
            width: 50px;
            height: 50px;
        }
        .mini-shopcart .btn-del {
            border: none;
            background: none;
            cursor: pointer;
        }
...
<nav class="navbar navbar-expand-lg navbar-custom">
    <a class="navbar-brand" href="index.php">
        <img src="images/icons/ic-logo-01.png" alt="Ecofood" style="width: 150px;">
    </a>
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link" href="admin_register.php">Admin Register</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="admin_login.php">Login</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="admin_slider.php">Manage Slider</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="admin_users.php">Manage Users</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="admin_products.php">Manage Product</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="admin_checkout.php">Order CheckOut</a>
            </li>
            <li class="nav-item">
    ...
    <div class="mini-shopcart" id="miniShopCart">
        ...
        <div class="foot-mini-shopcart">
            ...
            <div class="mini-shopcart-action">
                <button class="btn btn-outline-primary btn-viewcart">VIEW CART</button>
                <button class="btn btn-primary btn-checkout">CHECK OUT</button>
            </div>
        </div>
    </div>
</nav>
