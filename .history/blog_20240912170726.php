...
<head>
    ...
    <style>
        .blog-content img {
            width: 100%;
            height: auto;
            max-height: 500px; /* Ensure image height does not exceed this value */
            object-fit: cover;
            margin-bottom: 20px;
        }

        .blog-description {
            max-height: 200px; /* Maximum height of the description */
            overflow: hidden; /* Hide the overflow text */
            text-overflow: ellipsis; /* Add ellipsis for overflow text */
            display: -webkit-box;
            -webkit-box-orient: vertical;
            -webkit-line-clamp: 8; /* Number of lines to show before truncating */
            line-clamp: 8; /* For non-webkit browsers */
            padding-bottom: 10px;
        ...
        .sidebar img {
            width: 100%;
            height: auto;
            max-height: 200px; /* Adjust max height for sidebar images */
            object-fit: cover;
            margin-bottom: 10px;
        }
        ...
        .date-icon {
            ...
            margin-right: 10px; /* Space between icon and date text */
        }

        .date-container {
            font-size: 20px; /* Font size for date text */
