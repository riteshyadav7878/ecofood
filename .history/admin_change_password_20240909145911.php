...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['login_admin'])) {
    ...
    if ($result->num_rows > 0) {
        ...
        if (password_verify($password, $row['password'])) {
            ...
            header("Location: admin_change_password.php"); // Redirect to this page for password change
            exit();
        } else {
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['update_details']) && isset($_SESSION['admin_logged_in']) && $_SESSION['admin_logged_in'] === true) {
