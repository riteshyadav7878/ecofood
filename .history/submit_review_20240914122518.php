...
<script>
    ...
    // Example call to show the success message (you can remove this line in your actual use case)
    // Call this function to display the message for testing purposes
    document.addEventListener('DOMContentLoaded', function() {
        // Simulate showing the success message after 2 seconds for demonstration
