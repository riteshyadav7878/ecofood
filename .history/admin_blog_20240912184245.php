...
<script>
    ...
    function showUpdateForm(id, title, description, image) {
        ...
        if (image) {
            document.getElementById('update_image_preview').src = 'images/' +
            image; } else { document.getElementById('update_image_preview').src = ''; } document.getElementById('updateModal').style.display = 'flex'; }
...
</script> <script src="vendor/bootstrap/dist/js/bootstrap.bundle.min.js"></script> </body> </html> 