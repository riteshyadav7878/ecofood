...
<body>
    ...
    <div class="section white-background">
        <div class="container">
            ...
            <div class="row">
                <?php
                // Assuming $result is the result of the database query fetching product data
                // Example: $result = mysqli_query($conn, "SELECT * FROM products_table");
                ...
                if ($result && mysqli_num_rows($result) > 0) {
                    while ($row = mysqli_fetch_assoc($result)) { ?>
                        <div class="col-md-3 col-sm-6 mt-5">
                            <div class="product-1">
                                <div class="product-image">
                                    <!-- Dynamically fetch the image and display it -->
                                    <a href="product-details-02.php?id=<?php echo $row['id']; ?>" class="image-holder">
                                        ...
                                        <!-- Show the status (e.g., HOT, SALE, NEW) dynamically if set -->
                                ...
                                <div class="product-content">
                                    <h3 class="title">
                                        <a class="name" href="product-details-1.php?id=<?php echo $row['id']; ?>">
                    ...
                    // If no products are found or if there is an error
                    echo '<p>No products found or an error occurred.</p>';
                }
                ?>
            </div>
        </div>
