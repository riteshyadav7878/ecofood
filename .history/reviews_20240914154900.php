...
// Fetch all reviews with associated product details (including image) in descending order by review ID
$review_sql = "SELECT reviews.id, reviews.reviewer_name, reviews.review_text, product.title AS product_title, product.image AS product_image
               ...
               ORDER BY reviews.id DESC"; // Order by review ID in descending order
