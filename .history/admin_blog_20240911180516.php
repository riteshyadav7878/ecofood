...
<head>
    <meta charset="UTF-8">
    <title>Blog List - Ecofood HTML5 Templates</title>
                ...
                <?php while ($row = mysqli_fetch_assoc($result)): ?>
                    <div class="blog-item-1">
                        ...
                        <p class="blog-item-date">
                            ...
                            <span>on <?php echo date('F d, Y', strtotime($row['created_at'])); ?></span>
                        </p>
...
<script>
    ...
    document.querySelectorAll('.blog-item-img-link').forEach(function(link) {
