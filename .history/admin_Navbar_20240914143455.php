...
<li>
<a class="has-text-color-hover" href="admin_register.php">Product Reviews</a>
</li>
 
 <li class="has-drop">
<a class="has-text-color-hover" href="Billing_details.php">Order Details</a>
...
<li class="has-drop">
<a class="has-text-color-hover" href="admin_blog.php">Blog List</a>
<button class="btn-caret fa fa-angle-right"></button>
</li>
