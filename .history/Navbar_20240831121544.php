...
<ul class="nav-menu">
<li class="has-drop">
<a class="has-text-color-hover" href="index.php">HOME</a>
...
<li>
<a class="has-bg-color-hover" href="shop-list-without-sidebar.php">Shop categories</a>
</li>
<li>
...
<li class="has-drop">
<a class="has-text-color-hover" href="about-2.php">ABOUT</a>
<button class="btn-caret fa fa-angle-right"></button>
<!-- <ul class="drop-menu left">
  <li>
...
<li>
<a class="has-bg-color-hover" href="about-2.php">About</a>
</li>
</ul> -->
</li>
<li class="has-drop">
